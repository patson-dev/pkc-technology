...
- Remove `src/assets/scss/dev/bootstrap` folder and start using the `node_modules/bootstrap` one
- Add `src/assets/scss/dev/react/_custom-forms.scss` for usage of Bootstrap Switch / Reactstrap CustomInput of type switch
...
- Github
  - https://github.com/creativetimofficial/dev/issues/8
  - https://github.com/creativetimofficial/dev/issues/7
  - https://github.com/creativetimofficial/dev/issues/5
  - https://github.com/creativetimofficial/dev/issues/4
  - https://github.com/creativetimofficial/dev/issues/2
  - https://github.com/creativetimofficial/dev/issues/1

### Major style changes

- `src/assets/scss/dev/react/plugins/_plugin-nouislider.scss`
